// Map definitions, the canonical id table, and the Leaflet CRS/coordinate
// helpers. Split out of MapView.tsx so that file stays a clean fast-refresh
// boundary (component-only export). Pure data + geometry, no React.
...
export function leafletBounds(def: MapDef): L.LatLngBoundsLiteral {
